        ...
        <table class="table table-striped mx-2">
            ...
            <c:forEach var="b" items="${l}">
                <tr class="product">
                    ...
                    <td>${b.amount}</td>
                    <td>${b.supplierid}</td>
<td><a class="btn btn-outline-info" href="invoice/${b.invoice_id}">View</a>
    <a class="btn btn-outline-danger" href="/invoice/remove/${b.invoice_id}">Delete</a> </td>
                </tr>
        ...
        <center>
        <a class="btn btn-outline-success" href="/supplier/invoice">ADD Invoice</a>
        </center>
