...
<form:form method="POST"
           action="/save_register"  modelAttribute="c">

    <table class="table-striped table col-8 ">

        <tr>
            <td>Username</td>
            <td><form:input path="u.username" class="form-control"/></td>
        </tr>
        <tr>
            <td>Password</td>
            <td><form:input path="u.password" class="form-control"/></td>
        </tr>
        ...
        <tr>
            <td>Gender</td>
            <td><form:select path="p.gender" class="form-control" items="${bl}"/></td>
        ...
        <tr>
            <td></td>
            <td>
                <input type="submit" name="submit" class="btn btn-success text-center" value="Register"/></td>
        </tr>
    </table>
